...
2026년 3월 4일 15:31:25

### 문제 설명

<p>시대를 초월하는 검객 승균이는 자신의 문파 알프스검류를 단련하기 위해 신기술 천상용섬을 연마했다.</p>

<p>천상용섬은 눈앞의 <mjx-container class="MathJax" jax="CHTML" style="font-size: 99.9%; position: relative;"><mjx-math class="MJX-TEX" aria-hidden="true"><mjx-mi class="mjx-i"><mjx-c class="mjx-c1D441 TEX-I"></mjx-c></mjx-mi></mjx-math><mjx-assistive-mml unselectable="on" display="inline"><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>N</mi></math></mjx-assistive-mml><span aria-hidden="true" class="no-mathjax mjx-copytext">\(N\)</span></mjx-container>개의 물체를 베는 기술로써, 벨 때마다 베는 높이가 줄어들지 않고 유지되거나 증가한다.</p>
